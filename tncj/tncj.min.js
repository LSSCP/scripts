...
}); const chavy = init(); if ($request.url.match("findQuiz")) { const t = decrypt($response.body); if (0 == t.errcode) { const e = t.data.quiz, r = t.data.answer; chavy.msg("\u5934\u8111\u5403\u9e21", e, 0 == r ? "\u9519\u8bef \u2b55" : "\u2705 \u6b63\u786e") } chavy.done() } else chavy.done();
